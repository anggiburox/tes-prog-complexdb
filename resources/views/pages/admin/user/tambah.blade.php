...
<div class="pagetitle">
    <div class="card">
        <div class="card-title card-body">
            <h2 class='mt-3 text-black'>Form Tambah User</h2>
        </div>
    </div>
</div>
        ...
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/admin/user/storeweb" method="POST" id="form-submitTambah">
                        @csrf
...
<script>
    function form_submit() {
        document.getElementById('form-submitTambah').addEventListener('submit', function(event) {
            event.preventDefault();
            // Jika semua validasi berhasil, lanjutkan submit form

            if (document.getElementById('form-submitTambah').checkValidity()) {
                Swal.fire({
                    title: "Konfirmasi",
