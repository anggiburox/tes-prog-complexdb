...
<head>
    ...
    <!-- =======================================================
  * Template Name: Niceusers
  * Updated: Mar 09 2023 with Bootstrap v5.2.3
  * Template URL: https://bootstrapmade.com/nice-users-bootstrap-users-html-template/
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/users/dashboard">
            ...
            <!-- <li class="nav-item">
                <a class="nav-link collapsed" href="/users/user">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/users/posts">
