...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'id_user_roles' => 'required|integer',
        ], [
        ...
        return response()->json([
            ...
            'user' => $user->only(['user_id', 'name', 'email', 'id_user_roles', 'created_at', 'updated_at']),
        ], 201);
    }
    ...
    public function storeweb(Request $request)
    {
        ...
        return redirect('/admin/user/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages/admin/user/edit', ['users' => $users]);
    }
    ...
    public function detail($id)
    {
        ...
        $users = DB::table('users')->where('user_id', $id)->get();
        // passing data pangkat yang didapat ke view edit.blade.php
        return view('pages/admin/user/detail', ['users' => $users]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/admin/user')->withSuccess('Data berhasil diperbaharui');
    }
    ...
    public function hapus($id)
    {
        ...
        return redirect('/admin/user')->withDanger('Data berhasil dihapus');
    }
}
