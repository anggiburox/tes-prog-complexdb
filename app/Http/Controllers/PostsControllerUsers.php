...
class PostsControllerUsers extends Controller
{
    ...
    public function index()
    {
        ...
        $posts     = DB::table('posts')
            ...
            ->paginate(10);
        return view('pages/users/posts/index', ['posts' => $posts]);
    }

    public function tambah()
    {
        // $users = User::all();
        // return view('pages/users/posts/tambah', ['users' => $users]);
        ...
        return view('pages/users/posts/tambah', [
            'currentUser' => $user,
            'users' => $users
        ]);
    }
    ...
    public function storeweb(Request $request)
    {
        ...
        return redirect('/users/posts/')->withSuccess('Data berhasil disimpan');
    }
    ...
    public function edit($id)
    {
        ...
        return view('pages/users/posts/edit', [
            'currentUser' => $user,
            'users' => $users,
            'posts' => $posts
        ]);
        // passing data pangkat yang didapat ke view edit.blade.php
        // return view('pages/users/posts/edit', ['posts' => $posts, 'users' => $users]);
    }
    ...
    public function detail($id)
    {
        ...
        return view('pages/users/posts/detail', [
            'currentUser' => $user,
            'users' => $users,
            'posts' => $posts
        ]);
        // passing data pangkat yang didapat ke view edit.blade.php
        // return view('pages/users/posts/detail', ['posts' => $posts, 'users' => $users]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('/users/posts')->withSuccess('Data berhasil diperbaharui');
    }
    ...
    public function hapusdata($id)
    {
        ...
        // alihkan halaman ke halaman mitra_industri
        return redirect('/users/posts')->withDanger('Data berhasil dihapus');
    }
}
