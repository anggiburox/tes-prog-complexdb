...
class ProfileControllerUsers extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('pages/users/profile', ['pgw' => $pgw]);
    }
    ...
    public function editprofile(Request $request)
    {
        ...
        if ($user) {
            ...
            // alihkan halaman
            return redirect('/users/profile')->withSuccess('Data berhasil diperbaharui');
        }
